...
deliveryRouter.get('/roster', authorize(Permission.DELIVERY_VIEW), controller.roster);
...
deliveryRouter.patch('/:id', authorize(Permission.DELIVERY_MANAGE), validate({ params: idParamSchema, body: createDeliverySchema }), controller.update);
